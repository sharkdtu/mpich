...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline MPIR_Request *MPIDI_CH4I_am_request_init(MPIR_Request * req, MPIR_Request_kind_t kind,
                                                       int ref_count)
{
    int i;
...
#undef FUNCNAME
#define FUNCNAME MPIDI_CH4I_am_request_cpy
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
static inline void MPIDI_CH4I_am_request_cpy(MPIR_Request * dest, MPIR_Request * src)
{
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_CH4I_AM_REQUEST_CPY);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_CH4I_AM_REQUEST_CPY);
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_CH4I_AM_REQUEST_CPY);
    return;
  fn_fail:
    goto fn_exit;
}
